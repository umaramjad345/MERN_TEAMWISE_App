          ...
          <>
            ...
            >
              <Popover.Panel className="absolute left-1/2 z-10 mt-3 w-80 max-w-sm -translate-x-1/2 transform px-4 sm:px-0">
                <div className="flex items-center gap-4 rounded-lg shadow-lg  p-8 bg-white">
                  <div className="w-16 h-16 bg-slate-700 rounded-full text-white flex items-center justify-center text-2xl ">
